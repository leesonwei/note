...
public class ServerResponse<T extends Serializable> implements Serializable {
    ...
    public static <T extends Serializable> ServerResponse<T> createBySuccess(T data){
        ServerResponse<T> serverResponse = new ServerResponse<>(ResponseCode.SUCCESS.getCode(),data);
    ...
    public static <T extends Serializable> ServerResponse<T> createByErrorMessage(String errorMessage){
        return new ServerResponse<>(ResponseCode.ERROR.getCode(),errorMessage);
    }

    public static <T extends Serializable> ServerResponse<T> createByErrorCodeMessage(int errorCode, String errorMessage){
